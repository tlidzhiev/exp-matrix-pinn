...
def setup_saving(cfg: DictConfig) -> None:
    """
    Create the checkpoint directory for saving model weights.

    Parameters
    ----------
    cfg : DictConfig
        Configuration object containing trainer.checkpoint_dir.
    """
    checkpoint_dir = get_root() / cfg.trainer.checkpoint_dir
